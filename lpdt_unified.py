...
mod_results = lpdtFit.fit_model(df_accident, df_vehicle, df_person, first_year=1983, last_year=1993, 
#                    equal_mixing=['hour'], 
...
mod_results = lpdtFit.fit_model_mi(df_accident, df_vehicle, df_person, first_year=1983, last_year=1993, 
#                    equal_mixing=['hour'], 
                    equal_mixing=['year','state','weekend','hour'],
                    drinking_definition = 'bac_test_primary',                                     
#                    bac_threshold = 0.1, 
